 ...
 <body>
   <div class="container row" id="app">
     <div class="card card1 col-md-6 col-sm-12 col-xs-12">
       <div class="card-body">
         <div id="title">
         ...
         <form id="processforgot" method="post" action="processforgot.php">
           <v-form ref="processforgot">
            ...
            /> -->
               <v-text-field name="email" v-model="email" :rules="emailRules" outlined label="Email" placeholder="Enter your email" required></v-text-field>
             </div>
     ...
     <div class="card card2 col-md-6 d-xs-none">
       <div class="card-body">
         <div class="card-body">
